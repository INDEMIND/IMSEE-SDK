...
mv "$ROOT_DIR/_output/bin/indemindd.dll" "$ROOT_DIR/_install/bin/indemindd.dll"
mv "$ROOT_DIR/_output/lib/indemindd.lib" "$ROOT_DIR/_install/lib/indemindd.lib"
...
cp -f "$ROOT_DIR/scripts/win/cmake/indemind-targets.cmake" "$ROOT_DIR/_install/lib/cmake/indemind/"
cp -f "$ROOT_DIR/scripts/win/cmake/indemind-targets-release.cmake" "$ROOT_DIR/_install/lib/cmake/indemind/"
