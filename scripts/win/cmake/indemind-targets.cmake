...
foreach(_expectedTarget indemind)
...
if(NOT INDEMINDS_SDK_ROOT)
  if(DEFINED ENV{INDEMINDS_SDK_ROOT})
    set(INDEMINDS_SDK_ROOT $ENV{INDEMINDS_SDK_ROOT})
  else()
    get_filename_component(INDEMINDS_SDK_ROOT "${CMAKE_CURRENT_LIST_DIR}/../../.." ABSOLUTE)
  endif()
endif()

# The installation prefix configured by this project.
set(_IMPORT_PREFIX "${INDEMINDS_SDK_ROOT}")

# Create imported target indemind
add_library(indemind SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/indemind-targets-*.cmake")
